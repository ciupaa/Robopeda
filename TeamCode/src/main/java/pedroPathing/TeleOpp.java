...
public class TeleOpp extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        motor_glisiere = hardwareMap.get(DcMotor.class,"motor_glisiere");
...
//            /* TODO**/
           motor_stanga.setPower(-gamepad1.right_stick_y);
           motor_glisiere.setPower(gamepad1.right_stick_x);
...
// Set target position for the motor
                motor_stanga.setTargetPosition((int) armPosition);
